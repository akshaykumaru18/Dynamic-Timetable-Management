...
public class User {
    ...
    public User(String studentName, String lecturerName, String hodName, String phoneNumber, String profile_image,
                String security_level, String user_id, String emailID, String hodDepartment) {
